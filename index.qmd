...
R en RStudio: zie [https://posit.co/download/rstudio-desktop/](https://posit.co/download/rstudio-desktop/) 

Alternatief: [https://posit.cloud](https://posit.cloud)

Installeer ook alvast het package `mice` en het package `ggmice` van CRAN. De package set `tidyverse` is ook handig.

# Teaching team

[Gerko Vink](https://www.gerkovink.com) & Paolo Colussi
