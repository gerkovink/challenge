...
format: 
  revealjs:
    ...
    footer: Gerko Vink @ UU, 20 Dec 2023, Utrecht
    standalone: true
---
...
::: callout-tip
# Materials
- slides: [www.gerkovink.com/Anatomy](https://www.gerkovink.com/Anatomy)
- source: [github.com/gerkovink/Anatomy](https://github.com/gerkovink/Anatomy)
:::
...
::::{.columns}
:::{.column width="40%"}
![](images/anatomy/2. missingness_problem.png){width=90%}
:::
...
::::{.columns}
:::{.column width="40%"}
![](images/anatomy/3. random_sampling.png){width=90%}
:::
...
::::{.columns}
:::{.column width="50%"}
![](images/anatomy/4. sidestep1.png){width=90%}
:::
...
::::{.columns}
:::{.column width="50%"}
![](images/anatomy/5. sidestep2.png){width=90%}
:::
...
::::{.columns}
:::{.column width="70%"}
![](images/anatomy/6. Sample_uncertainty.png){width=90%}
:::
...
::::{.columns}
:::{.column width="60%"}
![](images/anatomy/7. confidence_intervals.png){width="90%"}
:::
...
::::{.columns}
:::{.column width="60%"}
![](images/anatomy/15. replication.png){width="90%"}
:::
...
::::{.columns}
:::{.column width="60%"}
![](images/anatomy/16. validation.png){width="80%"}
:::
...
::::{.columns}
:::{.column width="60%"}
![](images/anatomy/8. prediction_intervals.png){width="90%"}
:::
...
::::{.columns}
:::{.column width="40%"}
![](images/anatomy/chal.jpg){width=90%}
:::
:::{.column width="60%"}
...
::::{.columns}
:::{.column width="30%"}
![](images/anatomy/9.missingness.png){width=60%}
:::
...
::::{.columns}
:::{.column width="50%"}
![](images/anatomy/11. missingness_solved.png){width=80%}
:::
...
# Case 1: How to evaluate with a truth
...
::::{.columns}
:::{.column width="50%"}
![](images/anatomy/12. PPC_quadratic.png){width=80%}
:::
:::{.column width="50%"}
![](images/anatomy/13. PPC_linear.png){width=80%}
:::
...
<center>
![](images/anatomy/14. not_applicable.png){width=60%}
</center>
<br>
