...
# 3. Pearson divergence according to densyty ratio package
...
# 4.1 Compute confussion matrix of model in synthetic data
table(syn_data$DEATH_EVENT, predict(model, newdata = syn_data) > 0.5)
# 4.2 Compute confussion matrix of model in original data
